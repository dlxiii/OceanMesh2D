...
inputConf.base = [basedir,'OceanMesh2D/casesets/'];
...
inputConf.endDate = [inputConf.modelYear+3,01,01,00,00,00];
...
inputConf.river.infos = {...
    ...
    'Ebigawa'};
% Location of river file
inputConf.river.flux = [inputConf.base,'RiverDischarge/flux_const.csv'];
inputConf.river.temp = [inputConf.base,'RiverDischarge/temp_const.csv'];
inputConf.river.salt = [inputConf.base,'RiverDischarge/salt_const.csv'];
inputConf.river.location = [inputConf.base,'RiverDischarge/location.csv'];
...
% Save a new 2dm file from the adjusted points for final touching up in SMS.
write_SMS_2dm(fullfile(inputConf.outbase, [inputConf.casename, '_bak.2dm']), ...
        Mobj.tri, Mobj.x, Mobj.y, Mobj.h, Mobj.read_obc_nodes);
